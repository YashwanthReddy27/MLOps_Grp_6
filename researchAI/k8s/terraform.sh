...
terraform import google_storage_bucket.composer_logs_bucket "projects/mlops-gcp-lab1/locations/us-east1/buckets/airflow-logs-bucket-mlops-gcp-lab1"
terraform import google_logging_project_sink.composer_logs_sink "projects/mlops-gcp-lab1/sinks/airflow-logs-sink"